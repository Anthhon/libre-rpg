...
from apps.campaigns.views import campaign_list_render, campaign_creator_render, campaign_player_remove
...
urlpatterns = [
    ...
    path('campaign/<int:campaign_id>/player/remove/<int:player_id>', campaign_player_remove, name='player_remove'),
